...
CREATE TYPE notification_type AS ENUM ('BOOKING_REQUEST', 'BOOKING_CONFIRMED', 'BOOKING_CANCELLED', 'PAYMENT_RECEIVED', 'DEPOSIT_RELEASED', 'REVIEW_RECEIVED', 'MESSAGE_RECEIVED', 'KYC_APPROVED', 'KYC_REJECTED', 'DISPUTE_OPENED', 'DISPUTE_RESOLVED', 'PAYOUT_SENT', 'REMINDER', 'MARKETING');
